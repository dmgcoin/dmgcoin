...
// installService attempts to install the dmgcoin service. Typically this should
...
// removeService attempts to uninstall the dmgcoin service. Typically this should
...
// startService attempts to Start the dmgcoin service.
