...
import (
	...
	"github.com/dmgcoin/dmgcoin/util/mstime"
	"github.com/pkg/errors"
)

func (x *DmgcoinMessage_Version) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "DmgcoinMessage_Version is nil")
	}
...
func (x *VersionMessage) toAppMessage() (appmessage.Message, error) {
	...
	//  Full dmgcoin nodes set SubnetworkId==nil
	if err != nil && !errors.Is(err, errorNil) {
		return nil, err
	}
...
func (x *DmgcoinMessage_Version) fromAppMessage(msgVersion *appmessage.MsgVersion) error {
