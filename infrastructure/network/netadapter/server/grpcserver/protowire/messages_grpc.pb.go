...
type P2P_MessageStreamClient interface {
	Send(*DmgcoinMessage) error
	Recv() (*DmgcoinMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *DmgcoinMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*DmgcoinMessage, error) {
	m := new(DmgcoinMessage)
...
func (x *p2PMessageStreamServer) Send(m *DmgcoinMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*DmgcoinMessage, error) {
	m := new(DmgcoinMessage)
...
func (x *rPCMessageStreamClient) Send(m *DmgcoinMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*DmgcoinMessage, error) {
	m := new(DmgcoinMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *DmgcoinMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*DmgcoinMessage, error) {
	m := new(DmgcoinMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
