...
type GetBlockTemplateRequestMessage struct {
	...
	// Which dmgcoin address should the coinbase block reward transaction pay into
...
type GetBlockTemplateResponseMessage struct {
	...
	// Whether dmgcoin thinks that it's synced.
	// Callers are discouraged (but not forbidden) from solving blocks when dmgcoin is not synced.
	// That is because when dmgcoin isn't in sync with the rest of the network there's a high
...
type GetConnectedPeerInfoMessage struct {
	...
	// Whether this dmgcoin initiated the connection
	...
	// The timestamp of when this peer connected to this dmgcoin
