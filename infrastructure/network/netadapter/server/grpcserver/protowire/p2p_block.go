...
func (x *DmgcoinMessage_Block) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "DmgcoinMessage_Block is nil")
	}
	return x.Block.toAppMessage()
}

func (x *DmgcoinMessage_Block) fromAppMessage(msgBlock *appmessage.MsgBlock) error {
