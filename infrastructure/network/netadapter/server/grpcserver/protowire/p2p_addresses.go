...
func (x *DmgcoinMessage_Addresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "DmgcoinMessage_Addresses is nil")
	}
...
func (x *DmgcoinMessage_Addresses) fromAppMessage(msgAddresses *appmessage.MsgAddresses) error {
