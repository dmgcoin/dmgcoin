...
func (x *DmgcoinMessage_Transaction) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "DmgcoinMessage_Transaction is nil")
	}
	return x.Transaction.toAppMessage()
}

func (x *DmgcoinMessage_Transaction) fromAppMessage(msgTx *appmessage.MsgTx) error {
