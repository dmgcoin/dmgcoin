...
func (x *DmgcoinMessage_Reject) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "DmgcoinMessage_Reject is nil")
	}
...
func (x *DmgcoinMessage_Reject) fromAppMessage(msgReject *appmessage.MsgReject) error {
