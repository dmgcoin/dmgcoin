...
type grpcStream interface {
	Send(*protowire.DmgcoinMessage) error
	Recv() (*protowire.DmgcoinMessage, error)
}
...
func (c *gRPCConnection) receive() (*protowire.DmgcoinMessage, error) {
...
func (c *gRPCConnection) send(message *protowire.DmgcoinMessage) error {
