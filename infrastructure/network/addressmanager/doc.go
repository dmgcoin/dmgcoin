/*
Package addressmanager implements concurrency safe Dmgcoin address manager.

# Address Manager Overview

In order maintain the peer-to-peer Dmgcoin network, there needs to be a source
of addresses to connect to as nodes come and go. The Dmgcoin protocol provides
