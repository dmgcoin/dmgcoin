	...
	tests := []struct {
		...
		// Positive P2PK tests.
		{
			...
			f: func() (util.Address, error) {
				publicKey := []byte{
					...
					0xe3, 0x4c, 0xce, 0x70, 0xc8, 0x63, 0x73, 0x27, 0x3e, 0xfc,
					0xe3, 0x4c}
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixDmgcoin)
			},
		...
		},
		{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixDmgcoinTest)
			},
			passedPrefix:   util.Bech32PrefixDmgcoinTest,
			expectedPrefix: util.Bech32PrefixDmgcoinTest,
		},
		...
		// ECDSA P2PK tests.
		{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressPublicKeyECDSA(publicKey, util.Bech32PrefixDmgcoin)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixDmgcoin,
		},
		...
		// Positive P2SH tests.
		{
			...
			f: func() (util.Address, error) {
				script := []byte{
					...
					0xae}
				return util.NewAddressScriptHash(script, util.Bech32PrefixDmgcoin)
			},
			passedPrefix:   util.Bech32PrefixDmgcoin,
			expectedPrefix: util.Bech32PrefixDmgcoin,
		},
		{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixDmgcoin)
			},
			passedPrefix:   util.Bech32PrefixDmgcoin,
			expectedPrefix: util.Bech32PrefixDmgcoin,
		},
		{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixDmgcoinTest)
			},
			passedPrefix:   util.Bech32PrefixDmgcoinTest,
			expectedPrefix: util.Bech32PrefixDmgcoinTest,
		},
...
func TestDecodeAddressErrorConditions(t *testing.T) {
	tests := []struct {
		...
		{
			"dmgsim:raskzcg58mth0an",
			util.Bech32PrefixDmgcoinSim,
			"unknown address type",
		},
		{
			"dmgtest:qqq65mvpxcmajeq44n2n8vfn6u9f8l4zsy0xez0tzw",
			util.Bech32PrefixDmgcoin,
