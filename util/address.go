...
import (
	...
	"github.com/dmgcoin/dmgcoin/util/bech32"
)
...
const (
	...
	Bech32PrefixDmgcoinDev

	// Prefix for the test network.
	Bech32PrefixDmgcoinTest

	// Prefix for the simulation network.
	Bech32PrefixDmgcoinSim
)
...
// and a payload which encodes the dmgcoin network and address type. It is used
...
// with the passed dmgcoin network.
