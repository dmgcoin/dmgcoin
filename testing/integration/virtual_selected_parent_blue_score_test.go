...
func TestVirtualSelectedParentBlueScoreAndVirtualDAAScore(t *testing.T) {
	...
	response, err := dmgcoin.rpcClient.GetVirtualSelectedParentBlueScore()
	if err != nil {
	...
	err = dmgcoin.rpcClient.RegisterForVirtualSelectedParentBlueScoreChangedNotifications(
	...
	err = dmgcoin.rpcClient.RegisterForVirtualDaaScoreChangedNotifications(
