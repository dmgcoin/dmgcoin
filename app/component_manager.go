...
import (
	...
	"github.com/dmgcoin/dmgcoin/app/rpc"
	...
	"github.com/dmgcoin/dmgcoin/infrastructure/network/netadapter/id"
	"github.com/dmgcoin/dmgcoin/util/panics"
)

// ComponentManager is a wrapper for all the dmgcoin services
...
// Start launches all the dmgcoin services.
...
// Stop gracefully shuts down all the dmgcoin services.
func (a *ComponentManager) Stop() {
	// Make sure this only happens once.
	if atomic.AddInt32(&a.shutdown, 1) != 1 {
		log.Infof("dmgcoin is already in the process of shutting down")
		return
	}

	log.Warnf("dmgcoin shutting down")
