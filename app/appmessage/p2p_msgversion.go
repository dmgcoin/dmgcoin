...
var DefaultUserAgent = fmt.Sprintf("/dmgcoin:%s/", version.Version())

// MsgVersion implements the Message interface and represents a dmgcoin version
...
// NewMsgVersion returns a new dmgcoin version message that conforms to the
