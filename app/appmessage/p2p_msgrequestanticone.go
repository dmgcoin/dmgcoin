...
// MsgRequestAnticone implements the Message interface and represents a dmgcoin
...
// NewMsgRequestAnticone returns a new dmgcoin RequestPastDiff message that conforms to the
