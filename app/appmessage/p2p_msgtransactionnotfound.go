...
// MsgTransactionNotFound defines a dmgcoin TransactionNotFound message which is sent in response to
...
// NewMsgTransactionNotFound returns a new dmgcoin transactionsnotfound message that conforms to the
