...
// MsgIBDChainBlockLocator implements the Message interface and represents a dmgcoin
...
// NewMsgIBDChainBlockLocator returns a new dmgcoin locator message that conforms to
