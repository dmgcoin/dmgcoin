...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a dmgcoin
...
// NewMsgDoneBlocksWithTrustedData returns a new dmgcoin DoneBlocksWithTrustedData message that conforms to the
// Message interface.
