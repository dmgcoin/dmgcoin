...
// RPCTransaction is a dmgcoin transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a dmgcoin transaction input representation
...
// RPCScriptPublicKey is a dmgcoin ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a dmgcoin transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a dmgcoin outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a dmgcoin utxo entry representation meant to be used
// over RPC
