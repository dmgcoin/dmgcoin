...
// MsgRequestNextHeaders implements the Message interface and represents a dmgcoin
...
// NewMsgRequestNextHeaders returns a new dmgcoin RequestNextHeaders message that conforms to the
// Message interface.
