...
// MsgDoneHeaders implements the Message interface and represents a dmgcoin
...
// NewMsgDoneHeaders returns a new dmgcoin DoneIBDBlocks message that conforms to the
// Message interface.
