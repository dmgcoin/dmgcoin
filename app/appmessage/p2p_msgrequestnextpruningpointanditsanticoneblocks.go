...
// MsgRequestNextPruningPointAndItsAnticoneBlocks implements the Message interface and represents a dmgcoin
...
// NewMsgRequestNextPruningPointAndItsAnticoneBlocks returns a new dmgcoin RequestNextPruningPointAndItsAnticoneBlocks message that conforms to the
// Message interface.
