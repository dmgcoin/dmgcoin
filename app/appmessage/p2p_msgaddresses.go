...
// dmgcoin Addresses message (MsgAddresses).
const MaxAddressesPerMsg = 1000

// MsgAddresses implements the Message interface and represents a dmgcoin
// Addresses message.
...
// NewMsgAddresses returns a new dmgcoin Addresses message that conforms to the
