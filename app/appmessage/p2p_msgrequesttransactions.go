...
// MsgRequestTransactions implements the Message interface and represents a dmgcoin
...
// NewMsgRequestTransactions returns a new dmgcoin RequestTransactions message that conforms to
