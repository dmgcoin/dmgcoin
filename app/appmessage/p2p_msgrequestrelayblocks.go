...
// MsgRequestRelayBlocks implements the Message interface and represents a dmgcoin
...
// NewMsgRequestRelayBlocks returns a new dmgcoin RequestRelayBlocks message that conforms to
