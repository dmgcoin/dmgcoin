...
// MsgRequestHeaders implements the Message interface and represents a dmgcoin
...
// NewMsgRequstHeaders returns a new dmgcoin RequestHeaders message that conforms to the
