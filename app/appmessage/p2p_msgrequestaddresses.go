...
// MsgRequestAddresses implements the Message interface and represents a dmgcoin
...
// NewMsgRequestAddresses returns a new dmgcoin RequestAddresses message that conforms to the
