...
func (v *transactionValidator) checkTransactionAmountRanges(tx *externalapi.DomainTransaction) error {
	...
	// as a sompi. One Dmgcoin is a quantity of sompi as defined by the
	// sompiPerDmgcoin constant.
	...
	for _, txOut := range tx.Outputs {
		...
		// This is impossible for Dmgcoin, but perhaps possible if an alt increases
