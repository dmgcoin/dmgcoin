/*
Package txscript implements the Dmgcoin transaction script language.

This package provides data structures and functions to parse and execute
Dmgcoin transaction scripts.

# Script Overview

Dmgcoin transaction scripts are written in a stack-base, FORTH-like language.

The Dmgcoin script language consists of a number of opcodes which fall into
...
Typical Dmgcoin scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend Dmgcoin.
