...
// SignatureScript creates an input signature script for tx to spend DMGC sent
...
// SignatureScriptECDSA creates an input signature script for tx to spend DMGC sent
