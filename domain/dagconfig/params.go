...
// Params defines a Dmgcoin network by its parameters. These parameters may be
// used by Dmgcoin applications to differentiate networks as well as addresses
...
type Params struct {
	...
	// PruningProofM is the 'm' constant in the pruning proof. For more details see: https://github.com/dmgcoin/research/issues/3
...
// MainnetParams defines the network parameters for the main Dmgcoin network.
var MainnetParams = Params{
	K:           defaultGHOSTDAGK,
	Name:        "dmgcoin-mainnet",
...
// TestnetParams defines the network parameters for the test Dmgcoin network.
var TestnetParams = Params{
	K:           defaultGHOSTDAGK,
	Name:        "dmgcoin-testnet-10",
...
// DevnetParams defines the network parameters for the development Dmgcoin network.
...
// ErrDuplicateNet describes an error where the parameters for a Dmgcoin
// network could not be set due to the network already being a standard
// network or previously-registered into this package.
var ErrDuplicateNet = errors.New("duplicate Dmgcoin network")

var registeredNets = make(map[appmessage.DMGCoinNet]struct{})

// Register registers the network parameters for a Dmgcoin network. This may
