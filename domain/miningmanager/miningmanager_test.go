...
import (
	...
	"github.com/dmgcoin/dmgcoin/domain/miningmanager/model"
	...
	"github.com/dmgcoin/dmgcoin/domain/miningmanager"
...
func generateNewCoinbase(addressPrefix util.Bech32Prefix, op opType) (*externalapi.DomainCoinbaseData, error) {
	...
	_, publicKey, err := libdmgcoinwallet.CreateKeyPair(op == opECDSA)
	if err != nil {
		return nil, err
	}
	var address string
