...
import (
	...
	"github.com/dmgcoin/dmgcoin/infrastructure/network/netadapter/standalone"
...
func main() {
	...
	dmgcoinConfig := config.DefaultConfig()
	dmgcoinConfig.NetworkFlags = cfg.NetworkFlags

	minimalNetAdapter, err := standalone.NewMinimalNetAdapter(dmgcoinConfig)
	if err != nil {
